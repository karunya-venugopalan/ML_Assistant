...
pred_cv_logistic
score_logistic = f1_score(pred_cv_logistic,y_cv)*100 
...
score_tree =f1_score(pred_cv_tree,y_cv)*100
...
score_forest = f1_score(pred_cv_forest,y_cv)*100
...
score_xgb = f1_score(pred_xgb,y_cv)*100
